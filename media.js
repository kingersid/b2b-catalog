// All media files deployed to the site (kept in sync with the folder).
// Display order matches the live catalog (index.html) — pulled from the
// Cloudflare Pages deployment. Shared by the price catalog (price-catalog.html)
// and the price admin page (admin.html) so the list only lives in one place.
